    ...
    <div className="min-h-screen bg-[#f5f3ef] flex items-center justify-center p-6">
      <div className="w-full max-w-md bg-white rounded-3xl p-8 shadow-xl shadow-stone-200/50 border border-stone-100">
        <div className="text-center mb-10">
          ...
          <p className="text-stone-500 text-sm">Join Notely and start organizing your thoughts.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="text-xs font-semibold text-stone-500 uppercase tracking-wider mb-1.5 block">Confirm Password</label>
            <input
              type="password"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3.5 mt-4 rounded-xl bg-stone-900 text-white font-semibold hover:bg-stone-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg shadow-stone-900/20 flex items-center justify-center gap-2"
          >
            {loading ? (
        ...
        <p className="mt-8 text-center text-sm text-stone-500">
          ...
          <Link to="/login" className="text-amber-600 font-bold hover:underline">Log in here</Link>
        </p>
      </div>
    </div>
  );
